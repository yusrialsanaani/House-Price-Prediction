...
Since we are working on predicting the house prices using machine learning, the objective of this project is not only to predict the houses sale, but also to design the project in a way that covers the important topics explained in the CENGN ML course, provides a clear instructions for learners to follow, create reliable and readable modular codes, enabling participants to check their code against project requirements.

For this purpose, selecting a project that leverages the supervised/ unsupervised ML techniques, utilizes different exploratory data analysis and processing techniques, enables the learner to engineer the features, and then select the appropriate ML algorithms will help the participants to review the course content and consolidate their learning as well.

After deep research and agreement of the mentor and CENGN&#39;s team, the house price prediction with Ames Housing Dataset is the best candidate for this project over other projects ideas and datasets.

Figure ‎4‑1demonstrates the general design process. As shown, the design process starts by understanding the problem requirements, and then selecting the project and dataset that meets the problem requirements. After investigating the ability of project to cover theses requirements, the next stage is to design the project and identify its workflow. The third stage is to evaluate the project against the requirements.

| ![](RackMultipart20220507-1-2ol76n_html_31c054b9cf8d5946.png) |
| --- |
| Figure ‎4‑1: The project design process. |

The general approach that will be used for the core project design follows the standard machine learning life cycle that includes project planning phase, data preparation, exploratory data analysis, features engineering, modeling, and predictions as shown in Figure ‎4‑2. Each step in the diagram shown in Figure ‎4‑2 will be described in the next subsections.
...
Supervised and unsupervised ML algorithms will be used in this project based on the potential problem that we are going to solve. CENGN&#39;s multi-vendor cloud, Jupyter Notebook, GITHUP will be used in this project.

| ![](RackMultipart20220507-1-2ol76n_html_7826889b3e5dba76.png) |
| --- |
| Figure ‎4‑2: The machine learning project life cycle. |
...
After exploring the data, the next step is to explore the target variable which is the &quot;SalePrice&quot;. Univariate analysis will be used to get more knowledge about the target variable and other important dependant variables using distribution plots (histogram/displot) and probability plot. Multivariate analysis will be used to understand the relationship between the target variable (SalesPrice) and other variables (predictors). For numerical variables, scatter plot, correlation matrix, and pair plot will be used to study the relationship between target variable and numerical variables. For categorical variables, bar plot and boxplot will be used to study the relationship between target variable and categorical variables. Figure ‎4‑3 summarizes the workflow of exploratory data analysis.

| ![](RackMultipart20220507-1-2ol76n_html_784dcb6de6ac4eef.png) |
| --- |
| Figure ‎4‑3: Exploratory Data Analysis Workflow. |

  1.
## Data Processing

Data preprocessing is an extremely important step in machine learning to enhance the quality of data to promote the extraction of meaningful insights from the data. Data preprocessing in machine learning refers to the technique of preparing (cleaning and organizing) the raw data to make it suitable for a building and training machine learning models. The steps in data preprocessing pipeline are shown in Figure ‎4‑4, which includes:
...
| ![](RackMultipart20220507-1-2ol76n_html_2544618b9672ad6.png) |
| --- |
| Figure ‎4‑4: Data Processing Pipeline. |
...
In this project, many features engineering techniques have been used to create features pipeline as shown in Figure ‎4‑5.

| ![](RackMultipart20220507-1-2ol76n_html_49ee513c16c6d01.png) |
| --- |
| Figure ‎4‑5: Features Engineering Pipeline. |
...
The objective of this project is to leverage supervised and unsupervised learning algorithms to provide a good coverage for the content of CENGN machine learning course. For this reason, the Ames Housing dataset was chosen due to its richness and huge features that allow us to utilize many machine learning techniques at each stage of the ML project&#39;s life cycle.
...
Figure ‎4‑7summarizes the evaluation metrics used for evaluating the performance of regression and clustering models.

| ![](RackMultipart20220507-1-2ol76n_html_bf86a6040e13b047.png) |
| --- |
| Figure ‎4‑7: Evaluation metrics for regression and clustering models. |

  1.
## Best Model Selection and Hyperparameters Tuning
...
The first step is to check the types of variables the train dataset has. By using Python, the type of variables has been identified as shown in Figure ‎5‑1. It is clear the dataset has 38 numerical (quantitative) variables and 43 categorical (qualitative) variables as well. Also, there are no duplicates in the dataset.

| ![](RackMultipart20220507-1-2ol76n_html_e3f7fa95064b666e.png) |
| --- |
| Figure ‎5‑1: Identifying numerical and categorical variables. |

It is difficult to show some rows of dataset here due to its large number of columns, however, we can split the dataset based on its data type and display it here in two parts, numerical variables as in Figure ‎5‑2 (a) and categorical variables as in Figure ‎5‑2 (b).

| ![](RackMultipart20220507-1-2ol76n_html_408944d03d635041.png) | ![](RackMultipart20220507-1-2ol76n_html_2672d61db79a6902.png) |
| --- | --- |
|
...
1. Categorical variables
 |
| Figure ‎5‑2: Displaying the dataset. |
...
| Table ‎5‑1.Generating descriptive statistics for SalePrice variable. |
| --- |
| ![](RackMultipart20220507-1-2ol76n_html_abd14a8ea08fe183.png) |
...
| ![](RackMultipart20220507-1-2ol76n_html_e4001884151dc8d9.png) |
| --- |
| Figure ‎5‑3: SalePrice (Target Variable) distribution. |

| ![](RackMultipart20220507-1-2ol76n_html_1d56f2b5a42325ab.png) |
| --- |
...
Table ‎5‑2shows the summary of these descriptive statistics for numerical variables. Also, we can obtain a concise summary of them including the index data type and columns, non-null values and memory usage as shown in Table ‎5‑3.
...
| _Table ‎5‑2.Generating descriptive statistics for numerical variables._ |
| --- |
| ![](RackMultipart20220507-1-2ol76n_html_a8ae79666f1b8649.png) |

| _Table ‎5‑3.Generating concise information summary for numerical variables._ |
| --- |
| ![](RackMultipart20220507-1-2ol76n_html_73f39c3ad4e37c37.png) |

| Table ‎5‑4.Generating descriptive statistics for categorical variables. |
| --- |
| ![](RackMultipart20220507-1-2ol76n_html_a38cf56e4202daeb.png) |

| _Table ‎5‑5.__Generating concise information summary for categorical variables._ |
| --- |
| ![](RackMultipart20220507-1-2ol76n_html_4f86ac0920f71f3a.png) |
...
| ![](RackMultipart20220507-1-2ol76n_html_da0034833f1d6cdc.png) |
| --- |
| Figure ‎5‑5: The distribution plots for numerical variables using distplot. |
| ![](RackMultipart20220507-1-2ol76n_html_aeb9a00e0f8a5aec.png) |
| Figure ‎5‑6: The distribution plots for numerical variables using histplot. |

| ![](RackMultipart20220507-1-2ol76n_html_87d7e4cc04b79b8f.png) | ![](RackMultipart20220507-1-2ol76n_html_38d09350be1517c5.png) |
| --- | --- |
|
1. distplot
 |
...
| ![](RackMultipart20220507-1-2ol76n_html_ff9b8fe09ac562b0.png) | ![](RackMultipart20220507-1-2ol76n_html_5e305fa9f0788c23.png) |
|
1. distplot
 |
1. histplot
...
| ![](RackMultipart20220507-1-2ol76n_html_ce44aee968242b8f.png) | ![](RackMultipart20220507-1-2ol76n_html_a87bdb4687d78c69.png) |
| --- | --- |
| (a) | (b) |
| ![](RackMultipart20220507-1-2ol76n_html_1373784ec6fa1495.png) | ![](RackMultipart20220507-1-2ol76n_html_5fd6a0b683d6ed7d.png) |
| (c) | (d) |
| ![](RackMultipart20220507-1-2ol76n_html_58b58a7ccb355ab2.png) | ![](RackMultipart20220507-1-2ol76n_html_58e80654819502d5.png) |
| (e) | (f) |
| ![](RackMultipart20220507-1-2ol76n_html_d97cc6a36fa02cce.png) | ![](RackMultipart20220507-1-2ol76n_html_f8bb72dbc9bd2fc6.png) |
| (g) | (h) |
| ![](RackMultipart20220507-1-2ol76n_html_bedd6a771f0263bf.png) | ![](RackMultipart20220507-1-2ol76n_html_e5281b5c57fffd0d.png) |
| (i) | (j) |
| ![](RackMultipart20220507-1-2ol76n_html_b44bd81e92c111eb.png) | ![](RackMultipart20220507-1-2ol76n_html_c61951b77f5efa70.png) |
| (k) | (l) |
| ![](RackMultipart20220507-1-2ol76n_html_af1336f1828dcde5.png) |
| (m) |
...
| ![](RackMultipart20220507-1-2ol76n_html_4acda71193ab4760.png) |
| --- |
| Figure ‎5‑10: The relationship plot between SalePrice and GrLivArea. |
| ![](RackMultipart20220507-1-2ol76n_html_a07496fe1a60fb56.png) |
...
| ![](RackMultipart20220507-1-2ol76n_html_827416ce47967ed4.png) | ![](RackMultipart20220507-1-2ol76n_html_827416ce47967ed4.png) |
| --- | --- |
| ![](RackMultipart20220507-1-2ol76n_html_59248485ff27283d.png) |
| Figure ‎5‑12: The correlation of all numerical variables with SalePrice. |

| ![](RackMultipart20220507-1-2ol76n_html_9d3980a3987b6f42.png) |
| --- |
...
| ![](RackMultipart20220507-1-2ol76n_html_e4350fcbcebc24bc.png) |
| --- |
| Figure ‎5‑14: The correlation of numerical variables with SalePrice when correlation \&gt; 0.5 |
| ![](RackMultipart20220507-1-2ol76n_html_59e34a9ce92cb5fa.png) |
| Figure ‎5‑15: The correlation matrix for most top correlated features. |

| ![](RackMultipart20220507-1-2ol76n_html_a07496fe1a60fb56.png) | ![](RackMultipart20220507-1-2ol76n_html_3a0d0c147e7b9516.png) |
| --- | --- |
| **(a)** | **(b)** |
| ![](RackMultipart20220507-1-2ol76n_html_4c59895cc590ec0d.png) | ![](RackMultipart20220507-1-2ol76n_html_4acda71193ab4760.png) |
| **(c)** | **(d)** |
| ![](RackMultipart20220507-1-2ol76n_html_1c3ff0cba3e886d5.png) | ![](RackMultipart20220507-1-2ol76n_html_72a09724080cb9de.png) |
| **(e)** | **(f)** |
...
Figure ‎5‑17shows the relationship between Neighborhood and SalePrice. We can see that there are some outliers need to be eliminated. Similarly, Figure ‎5‑18 (a-l) shows the relationship between selected categorical variables mentioned above and SalePrice. We can see that there are some outliers need to be eliminated as well.

| ![](RackMultipart20220507-1-2ol76n_html_e2ea403998e1afcb.png) |
| --- |
| Figure ‎5‑17: The relationship plot between SalePrice and Neighborhood. |

| ![](RackMultipart20220507-1-2ol76n_html_3edfe91a212d5e57.png) | ![](RackMultipart20220507-1-2ol76n_html_a1fd2113f3b5c493.png) |
| --- | --- |
| **(a)** | **(b)** |
| ![](RackMultipart20220507-1-2ol76n_html_da6d73d265b02dc9.png) | ![](RackMultipart20220507-1-2ol76n_html_2666098c7d1954e4.png) |
| **(c)** | **(d)** |
| ![](RackMultipart20220507-1-2ol76n_html_2c759f4f238462b3.png) | ![](RackMultipart20220507-1-2ol76n_html_218aa90de309081f.png) |
| **(e)** | **(f)** |
| ![](RackMultipart20220507-1-2ol76n_html_4b5cba20d7fea4a1.png) | ![](RackMultipart20220507-1-2ol76n_html_14e62318fce4b9fb.png) |
| **(g)** | **(h)** |
| ![](RackMultipart20220507-1-2ol76n_html_7e57fe7efcb10c59.png) | ![](RackMultipart20220507-1-2ol76n_html_57cebd12e4492aa6.png) |
| **(i)** | **(j)** |
| ![](RackMultipart20220507-1-2ol76n_html_374fb11d7ce3a2b.png) | ![](RackMultipart20220507-1-2ol76n_html_3f77361282a2ae7e.png) |
| **(k)** | **(l)** |
...
Figure ‎5‑21shows the scatter plot between SalePrice and TotalBsmtSF after outliers removal using IQR method. It is clear that IQR method is stricter that visual one because it removed low and high outliers.

| ![](RackMultipart20220507-1-2ol76n_html_f701048c38ede050.png) |
| --- |
| Figure ‎5‑19: The scatter plot between SalePrice and TotalBsmtSF. |
| ![](RackMultipart20220507-1-2ol76n_html_328b115f19dfa34b.png) |
| Figure ‎5‑20: The scatter plot between SalePrice and TotalBsmtSF after outliers removal using visual method. |
| ![](RackMultipart20220507-1-2ol76n_html_52ec261123402ef1.png) |
...
Figure ‎5‑23shows the scatter plot between SalePrice and GrLivArea after outliers removal using Visual method whereas Figure ‎5‑24 shows the removing outliers using IQR method. We followed the same way to check the outliers and remove them if available in other variables as a step in data preprocessing. So, we provide only two examples here to show how we treated the outliers in the dataset and make the report short instead of filling it with repeated examples.

| ![](RackMultipart20220507-1-2ol76n_html_e63337ede19fee21.png) |
| --- |
| Figure ‎5‑22: The scatter plot between SalePrice and GrLivArea. |
| ![](RackMultipart20220507-1-2ol76n_html_f7d01a0416ff14cf.png) |
| Figure ‎5‑23: The scatter plot between SalePrice and GrLivArea after outliers removal using Visual method. |
| ![](RackMultipart20220507-1-2ol76n_html_e23aa03e268c9163.png) |
...
| _Table ‎5‑6._ _Missing values and their_ _percentages._ |
| --- |
| ![](RackMultipart20220507-1-2ol76n_html_f03b96b08c7c1f04.png) |
| ![](RackMultipart20220507-1-2ol76n_html_2335f475750d119d.png) |
| Figure ‎5‑25: The percentages of missing vales |
| ![](RackMultipart20220507-1-2ol76n_html_edcd90bd759e5b26.png) |
...
| ![](RackMultipart20220507-1-2ol76n_html_fb4e0f50431f02ae.png) |
| --- |
| Figure ‎5‑27: SalePrice (Target Variable) before log transformation. |
| ![](RackMultipart20220507-1-2ol76n_html_4438408a3af37a33.png) |
| Figure ‎5‑28: The probability plot for SalePrice variable before log transformation. |
| ![](RackMultipart20220507-1-2ol76n_html_6ce47ff754245e2.png) |
| Figure ‎5‑29: SalePrice (Target Variable) after log transformation. |
| ![](RackMultipart20220507-1-2ol76n_html_9cdcbab418550f93.png) |
...
| ![](RackMultipart20220507-1-2ol76n_html_f9c3ad0e18890419.png) |
| --- |
...
| ![](RackMultipart20220507-1-2ol76n_html_4fc51b328fa0855f.png) |
| --- |
...
| ![](RackMultipart20220507-1-2ol76n_html_addd47dfa86bb324.png) |
| --- |
| Figure ‎5‑33: The distribution per category of GarageQual variable before simplification. |

| ![](RackMultipart20220507-1-2ol76n_html_852ddfd682d3e9be.png) |
| --- |
...
| _Table ‎5‑7._ _The 10 top features obtained from filter feature selection__._ |
| --- |
| ![](RackMultipart20220507-1-2ol76n_html_6ec0671af658a4b9.png) |
...
| ![](RackMultipart20220507-1-2ol76n_html_d52e3ddf84d8b77d.png) |
| --- |
| Figure ‎5‑35: The mutual information scores. |
| ![](RackMultipart20220507-1-2ol76n_html_c7f8e8774ff29053.png) |
| Figure ‎5‑36: Theinteraction effect between GrLivArea and BldgType. |

    1.
## Creating New Feature Using Clustering
...
| ![](RackMultipart20220507-1-2ol76n_html_a220b8b42dffda8c.png) |
| --- |
| Figure ‎5‑37: Theelbow method to find the appropriate number of clusters. |
| ![](RackMultipart20220507-1-2ol76n_html_25fa521c2aebf173.png) |
| Figure ‎5‑38: The clusters visualization of k-means model. |
| ![](RackMultipart20220507-1-2ol76n_html_f9062b22d6b738f2.png) |
...
| ![](RackMultipart20220507-1-2ol76n_html_ad12f8caaf7c47fb.png) |
| --- |
| Figure ‎5‑40: The dendrogram plot for hierarchical clustering. |
| ![](RackMultipart20220507-1-2ol76n_html_9c4413d24e9302d3.png) |
...
Figure ‎5‑44shows the RMSE for baseline models, it is clear that extreme gradient boosting (XGB) has the lowest RMSE value followed by regression tree (RT) model, whereas liner regression (LR) model has the highest value.

| ![](RackMultipart20220507-1-2ol76n_html_24870815fe26c4b9.png) |
| --- |
| Figure ‎5‑44: The RMSE for baseline models. |

    1.
## Regression Models with Engineered Features
...
| ![](RackMultipart20220507-1-2ol76n_html_4a73d6e7117f6ce8.png) |
| --- |
| Figure ‎5‑45: The RMSE for regression models after applying features engineering. |
| ![](RackMultipart20220507-1-2ol76n_html_aff7c59ee88b9b3.png) |
| Figure ‎5‑46: The RMSE of regression models before and after applying features engineering. |

| _Table ‎5‑8._ _RMSE values for regression models before and after applying features engineering._ |
| --- |
| ![](RackMultipart20220507-1-2ol76n_html_8c629eaf829fb8c8.png) |
|
 |

| ![](RackMultipart20220507-1-2ol76n_html_339697b3505fdbe4.png) |
| --- |
...
| _Table ‎5‑9._ _The sale price predictions for houses prices using XGB model._ |
| --- |
| ![](RackMultipart20220507-1-2ol76n_html_b007a76b50ad0987.png) |
|
 |
...
| ![](RackMultipart20220507-1-2ol76n_html_559d48ab19dd18bd.png) |
| --- |
| Figure ‎5‑48: Feature importance based on SHAP values. |
|
 |
| ![](RackMultipart20220507-1-2ol76n_html_c16a813bbf04136a.png) |
| ![](RackMultipart20220507-1-2ol76n_html_77f944ab18fe4502.png) |
| Figure ‎5‑49: Feature impact on the model prediction. |

| ![](RackMultipart20220507-1-2ol76n_html_954ea96eccfbc0a1.png) |
| --- |
| ![](RackMultipart20220507-1-2ol76n_html_966e0a8b29c0afe.png) |
| Figure ‎5‑50: Feature impact on overall model prediction. |

    1.
## Automated Solution Module
...
| ![](RackMultipart20220507-1-2ol76n_html_9dcd0e603f7f4d1d.png) |
| --- |
| Figure ‎5‑51: An example about how the instructions, hints, and solutions provided to the learners. |
| ![](RackMultipart20220507-1-2ol76n_html_62577b3b2b03d357.png) |
| Figure ‎5‑52: An example about how to provide automated hints. |

| ![](RackMultipart20220507-1-2ol76n_html_d23947f1e0060074.png) |
| --- |
| Figure ‎5‑53: An example about how to provide automated solutions. |

| ![](RackMultipart20220507-1-2ol76n_html_7d6404975cff3212.png) |
| --- |
| ![](RackMultipart20220507-1-2ol76n_html_7ce1818fcf16e5bd.png) |
...
[2] Q. Liu and Y. Wu, &quot;Supervised Learning,&quot; Encycl. Sci. Learn., pp. 3243–3245, 2012, doi: 10.1007/978-1-4419-1428-6\_451.

[3] M. Alloghani, D. Al-Jumeily, J. Mustafina, A. Hussain, and A. J. Aljaaf, &quot;A Systematic Review on Supervised and Unsupervised Machine Learning Algorithms for Data Science,&quot; pp. 3–21, 2020, doi: 10.1007/978-3-030-22475-2\_1.
